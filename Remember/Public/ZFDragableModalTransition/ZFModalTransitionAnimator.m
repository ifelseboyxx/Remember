...
- (instancetype)initWithModalViewController:(UIViewController *)modalViewController
{
    ...
    if (self) {
        ...
        _dragable = NO;
        _bounces = YES;
        _behindViewScale = 1.2f;
        _scaleY = 0.95f;
        _behindViewAlpha = 0.65f;
...
- (void)setDirection:(ZFModalTransitonDirection)direction
{
    ...
    if (_direction == ZFModalTransitonDirectionBottom) {
        _scaleY = 0.8;
        _transitionDuration = 0.45;
        _behindViewScale = _scaleY;
    }
}
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    if (!self.isDismiss) {
        ...
        [UIView animateWithDuration:[self transitionDuration:transitionContext] animations:^{
            fromViewController.view.transform = CGAffineTransformScale(fromViewController.view.transform, self.behindViewScale, _scaleY);
        ...
        if (![self isPriorToIOS8]) {
            toViewController.view.layer.transform = CATransform3DScale(toViewController.view.layer.transform, self.behindViewScale, _scaleY, 1);
        }
        ...
        [UIView animateWithDuration:[self transitionDuration:transitionContext] animations:^{
            ...
            CGFloat scaleBackY = (1 / _scaleY);
            toViewController.view.layer.transform = CATransform3DScale(toViewController.view.layer.transform, scaleBack, scaleBackY, 1);
...
- (void)updateInteractiveTransition:(CGFloat)percentComplete
{
    ...
    CATransform3D transform = CATransform3DMakeScale(
                                                     ...
                                                     1 + (((1 / _scaleY) - 1) * percentComplete), 1);
...
- (void)finishInteractiveTransition
{
    ...
    [UIView animateWithDuration:[self transitionDuration:transitionContext] animations:^{
        CGFloat scaleBack = (1 / self.behindViewScale);
        CGFloat scaleBackY = (1 / _scaleY);
        toViewController.view.layer.transform = CATransform3DScale(self.tempTransform, scaleBack, scaleBackY, 1);
        toViewController.view.alpha = 1.0f;
        fromViewController.view.frame = endRect;
    } completion:^(BOOL finished) {
        if (fromViewController.modalPresentationStyle == UIModalPresentationCustom) {
...
- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldRequireFailureOfGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer {
    if ((self.gestureRecognizerToFailPan && otherGestureRecognizer && self.gestureRecognizerToFailPan == otherGestureRecognizer) || self.direction == ZFModalTransitonDirectionBottom) {
        return YES;
    }
    return NO;
}
...
- (void)orientationChanged:(NSNotification *)notification
{
    ...
    backViewController.view.transform = CGAffineTransformScale(backViewController.view.transform, self.behindViewScale, _scaleY);
}
